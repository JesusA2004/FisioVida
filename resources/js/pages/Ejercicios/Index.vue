...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
                ...
                <div v-else class="grid gap-3 md:grid-cols-2">
                    ...
                    >
                        ...
                        <iframe
                            ...
                            class="mt-3 h-44 w-full rounded-xl border border-border"
        ...
        <Dialog :open="isOpen" @update:open="closeModal">
            <DialogContent
                class="max-w-3xl rounded-3xl border-none bg-card shadow-2xl"
            >
                <DialogHeader
                    ><DialogTitle>{{
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        ><textarea
                            ...
                            class="min-h-20 w-full rounded-2xl border border-input bg-card p-3"
                        />
                    </div>
