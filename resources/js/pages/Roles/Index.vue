        ...
        >
            ...
            >
                <div>
                    ...
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        Asigna permisos por acción, agrupados por módulo, con
                        control visual moderno.
                    </p>
                </div>
            ...
            >
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                    Crea un rol nuevo o ajusta los filtros actuales.
                </p>
            </div>
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            >
                                Permisos asignados:
                                <strong>{{ row.permissions_count }}</strong>
                            </p>
                        </div>
        ...
        <Dialog :open="isOpen" @update:open="closeModal">
            ...
            >
                <DialogHeader>
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400">
                        Permisos seleccionados: {{ selectedCount }}
                    </p>
                </DialogHeader>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Escribe nombre o slug"
                        />
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div
                            v-for="[module, permissions] in groupedPermissions"
                            :key="module"
                            class="rounded-2xl bg-zinc-50 p-4 dark:bg-zinc-900/60"
                        >
                            <div
                            ...
                            >
                                <label
                                    ...
                                    :key="permission.id"
                                    class="flex items-center gap-3 rounded-xl px-2 py-1 text-sm transition hover:bg-zinc-100 dark:hover:bg-zinc-800/60"
                                >
                                    <Checkbox
                                        :model-value="
