            ...
            <template v-else>
                ...
                >
                    <div>
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">
                            Gestiona expedientes, estado y contactos de
                            emergencia de forma centralizada.
                        </p>
                    </div>
                    <Button
                ...
                >
                    ...
                    <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
                        Agrega tu primer paciente o ajusta los filtros.
                    </p>
                </div>
                    ...
                    >
                        <div class="flex items-start justify-between gap-2">
                            <div>
                                ...
                                <div
                                    class="mt-1 flex items-center gap-2 text-xs text-zinc-500 dark:text-zinc-400"
                                >
                        ...
                        <div
                            class="mt-3 rounded-xl bg-zinc-50 p-3 text-xs text-zinc-600 dark:bg-zinc-900/60 dark:text-zinc-300"
                        >
                            <p>
        ...
        <Dialog :open="isOpen" @update:open="closeModal">
            ...
            >
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="space-y-2">
                        <Label>Nombres</Label><Input v-model="form.nombres" />
                        <p
                    ...
                    <div class="space-y-2">
                        <Label>Teléfono</Label><Input v-model="form.telefono" />
                    </div>
                    <div class="space-y-2">
                        <Label>Email</Label
                    ...
                    <div class="space-y-2">
                        <Label
                            ><ShieldAlert class="mr-1 inline h-4 w-4" />Contacto
                            emergencia</Label
