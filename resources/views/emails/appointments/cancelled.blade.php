...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f7f8;padding:32px 16px;">
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #e5e7eb;box-shadow:0 14px 40px rgba(15,23,42,0.08);">
      <tr>
        <td style="padding:30px;background:linear-gradient(135deg,#dc2626,#b91c1c);color:#ffffff;">
          <h1 style="margin:0;font-size:26px;font-weight:700;">❌ Cita cancelada</h1>
          <p style="margin:10px 0 0;font-size:15px;">Tu cita ha sido cancelada.</p>
        </td>
      </tr>
      <tr><td style="padding:30px;">
        <p style="margin:0 0 22px;font-size:15px;color:#4b5563;">Hola <strong>{{ $appointment['patient_name'] }}</strong>, te informamos que la siguiente cita ha sido cancelada:</p>
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:18px;margin:0 0 24px;overflow:hidden;">
          ...
          <tr><td style="padding:16px 20px;">
            ...
            <p style="margin:0;font-size:16px;font-weight:700;color:#111827;">{{ $date }} — {{ $startTime }}</p>
          </td></tr>
        </table>
        <p style="font-size:14px;color:#4b5563;">Si tienes alguna pregunta, contáctanos directamente.</p>
        <div style="text-align:center;margin:24px 0;">
          <a href="{{ $appointment['login_url'] ?? url('/login') }}" style="display:inline-block;background:#0EA5A4;color:#fff;text-decoration:none;padding:14px 26px;border-radius:16px;font-weight:700;font-size:15px;">Ir a FisioVida</a>
        </div>
      </td></tr>
